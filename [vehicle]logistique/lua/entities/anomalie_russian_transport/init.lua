...
AddCSLuaFile("ammo_system/cl_ammo_cache_menu.lua")
AddCSLuaFile("ammo_system/cl_ammo_cache_ui_russian.lua")
AddCSLuaFile("ammo_system/cl_ammo_cache_ui_french.lua")
include("ammo_system/sv_ammo_cache_menu.lua")
include("shared.lua")
include("ammo_system/sh_ammo_cache.lua")

if ENT.InitializeAmmoCaches then
	print("[AMMO SYSTEM] Successfully copied InitializeAmmoCaches function to entity")
else
	print("[ERROR] Failed to find InitializeAmmoCaches function in ENT table")
end

function ENT:OnSpawn(PObj)
	if self.InitializeAmmoCaches then
